...
M <- c(1000, 750, 550, 1200, 3500, 1500, 3000, 1000, 750, 3000, 3000, 2500)
...
if(FALSE) {
  jm <- jags.model("Code/JAGS/scr_all_sites_regression_varM.R", jags_data_site, inits = inits, n.adapt = 10, n.chains = 1)
...
if(FALSE) {
  library(jagsUI)
  jm <- jagsUI(data = jags_data_site, model.file = "Code/JAGS/scr_all_sites_regression_varM.R", parameters.to.save = parameters, inits = inits, n.chains = 1, n.adapt = 10, n.iter = 30, n.burnin = 20, n.thin = 1, modules = "glm")
}
